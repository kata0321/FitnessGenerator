  ...
  return (
    <div className="px-6 xl:w-3/4 mx-auto py-10 flex flex-col gap-20 text-md">
      ...
      <div className="flex flex-col gap-20">
        ...
        An overall summary of the fitness plan and current health
    </span>
        </div>
        {/* */}
        <div className="flex flex-col lg:flex-row items-center w-full h-full justify-between gap-10">
          ...
          <div className="flex flex-col gap-5 w-full h-full">
            <h3 className="text-xl font-semibold">Weight Evaluation</h3>
            <div>
              Your current weight (
            ...
            <Card className="bg-neutral-50 text-sm text-neutral-600 pt-2">
              <CardContent className="flex flex-col gap-2">
                ...
                <p className="flex flex-wrap gap-1">
                  This result has been calculated based on
                  <Sheet>
                  ...
                  BMI provides information about your weight status,
                  but it ignores factors such as muscle mass and body composition.
                  Two people with the same BMI may have different health profiles.
                </p>
              </CardContent>
            </Card>
          </div>
        ...
        <Card className="bg-neutral-50 text-sm text-neutral-600 pt-3">
          <CardContent className="flex flex-col gap-2">
            ...
            <p>
              The result of your current body composition health
              has been calculated taking into account your gender and age.
              This personalized approach helps provide a more accurate assessment
        ...
        <div className="flex flex-col lg:flex-row items-center w-full h-full justify-between gap-10">
          ...
          <div className="flex flex-col gap-5 w-full h-full">
            ...
            {ideal_weight === data.overview.weight && data.overview.fitness_goal !== 'build_muscle' && (
                <p>
                  Based on Dr. Miller's formula, your current weight is considered ideal.
                  Make sure to maintain this weight.
                </p>
            )}

            {ideal_weight !== data.overview.weight && data.overview.fitness_goal !== 'build_muscle' && (
                <p>
                  Based on Dr. Miller's formula and your fitness goal,
                  the ideal weight you can reach is
                  {' '}
                  {ideal_weight}
                  {' '}
                  Kg.
            ...
            {data.overview.fitness_goal === 'build_muscle' && (
                <p>
                  ...
                  {ideal_weight}
                  {' '}
                  Kg to appear muscular. Keep in mind that weight alone is not enough;
                  body fat percentage is also an important factor.
                </p>
            )}
          </div>
          ...
          <div className="flex flex-col gap-5 w-full h-full">
            ...
            {composition.ideal_fat >= composition.fat_percentage ? (
                ...
                <p>
                  Based on the ideal body fat percentages according to Jackson & Pollock
                  and your fitness goal, the perfect body composition you can work with
                  is
                  {' '}
                  {composition.ideal_fat}
                  %.
  ...
  <div className="flex flex-col gap-3">
    ...
    <p>
      ...
      {composition.fat_percentage > composition.ideal_fat
          && ` burn ${
              composition.fat_percentage - composition.ideal_fat
          } % of body fat to reach the suggested ideal body composition (${composition.ideal_fat} %).`}
      {composition.fat_percentage <= composition.ideal_fat
      ...
      <div className="flex flex-col gap-20">
        ...
        <div className="flex flex-col gap-5 w-full h-full">
          ...
          <p>
            {ideal_weight < data.overview.weight && `In order to lose 0.5 kg per week, you should consume ${calory_data.lose_05} calories per day.`}
            {ideal_weight > data.overview.weight && `In order to gain 0.5 kg per week, you should consume ${calory_data.gain_05} calories per day.`}
            {ideal_weight === data.overview.weight && `In order to maintain your current weight, you should consume ${calory_data.calories} calories per day.`}
          </p>
            {/* chart v2 */}
        ...
        <div className="flex flex-col lg:flex-row gap-10 items-start">
          ...
          {/* Fats */}
            <div className="flex flex-col gap-5 w-full h-full">
              ...
              <div className="text-3xl font-semibold text-emerald-500">
                {calory_data.fats_1} g to
                {' '}
                {calory_data.fats_2} g
              </div>
            </div>
            <p>
            ...
            <div className="flex flex-col gap-1">
              ...
              <ul className="list-disc list-inside">
                ...
                <li>Nut butter (e.g., almond butter, peanut butter)</li>
